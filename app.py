...
# ─── НОВАЯ СТРАНИЦА: Описание признаков ────────────────────────────────────────
    ...
    st.info("Не все 22 признака перечислены выше — для полного списка смотрите код или датасет.Так как мы несколько маловлиятельных уже удалил чтобы они просто времени не брали. Короче самые важные: SSLfinal_State и URL_of_Anchor!")
