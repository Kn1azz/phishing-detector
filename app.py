...
#    тут страница проверка сайта 
    ...
    # Небольшая атмосферная картинка сверху (защита / предупреждение)
    st.image(
        "https://images.unsplash.com/photo-1563986768609-620da13593e0?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80",
        caption="Будьте осторожны в интернете",
        use_column_width=True
    )
    ...
    **1** — нормально / хорошо
    ...
    # ... (твой код ввода признаков и кнопки остаётся без изменений)
    
    # После результата можно добавить маленькую иконку/картинку в зависимости от результата
    if st.button("🚀 Проверить сайт", type="primary", use_column_width=True):
