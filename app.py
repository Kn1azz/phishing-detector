...
st.sidebar.caption("         Душанбе, Точикистон  2026-сол")
...
if page == "Главная":
    ...
    st.markdown("""
    ### Проект:                            Проверки сайтов на фишинг
    ...
    **Нужно в раздел «Проверка сайта»** перейти, чтобы начать **АНАЛИЗ**
    """)
        ...
        with st.spinner("Анализирую..."):
            ...
            try:
                ...
                if pred == 1:
                    ...
                    Вероятность фишинга: **{proba:.1f}%**
                    st.image("photos/ph.jpg",
                    caption="Выглядить безопасно",
                    width=400)
